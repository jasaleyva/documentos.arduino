//Gracias a Eduard M. por su lección de cómo usar el sensor de orientación de un móvil
//https://appinventor.pevest.com/2014/10/29/sensors-using-the-orientation-sensor/

//Gracias a Eduardo Vega por su vídeo tutorial y su web sobre cómo enviar datos desde el móvil a arduino vía BlueTooth
