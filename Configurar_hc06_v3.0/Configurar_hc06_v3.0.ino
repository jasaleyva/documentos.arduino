...
SoftwareSerial BT1(A0,A1); // RX, TX recordar que se cruzan,
//Conectar así, HC06_RX-> A1, HC06_TX->A0
//Monitor Serie 9600 baudios y Nueva Línea

//COMANDOS AT en PDF
//"HC-06_serial_module_AT_COMANDOS.pdf" en carpeta /Arduino
//TEST:    AT
//Mostrar direccion:  AT+ADDR?
//Mostrar nombre:     AT+NAME?
//Poner Nombre:  AT+NAME= “nuevonombre”\r\n
//Mostrar contraseña:   AT+ PSWD?
//Poner constraseña:    AT+PSWD=<Param>
//VER BAUDIOS:  AT+UART?
//RESETEAR: AT+RESET
//RESTORE DEFAULT STATUS:  AT+ORGL
void setup()
   {
       Serial.begin(9600);
